...
var tt = class {
  ...
  createBookItem(e) {
    ...
    return xe(
      ...
      this.getISBN(e.industryIdentifiers),
    );
  }
  convertGoogleBookImageURLSize(e, t) {
...
function Ht(r) {
  if (r.serviceProvider === N.google) return new tt(r.localePreference);
  if (r.serviceProvider === N.naver) {
    if (!r.naverClientId || !r.naverClientSecret)
      throw new Error(
        '\uB124\uC774\uBC84 \uAC1C\uBC1C\uC790\uC13C\uD130\uC5D0\uC11C "Client ID"\uC640 "Client Secret"\uB97C \uBC1C\uAE09\uBC1B\uC544 \uC124\uC815\uD574\uC8FC\uC138\uC694.',
      );
    return new rt(r.naverClientId, r.naverClientSecret);
  }
}
function He(o) {
  return g(this, arguments, function* (r, e = {}, t) {
    let n = new URL(r);
    return (
      Object.entries(e).forEach(([s, a]) => {
        n.searchParams.append(s, a == null ? void 0 : a.toString());
      }),
...
var ot = class extends oe.Modal {
  constructor(e, t, o) {
    super(e.app);
    this.query = t;
    this.callback = o;
    this.isBusy = !1;
    this.serviceProvider = Ht(e.settings);
  }
  setBusy(e) {
    var t, o;
    (this.isBusy = e),
  ...
  searchBook() {
    return g(this, null, function* () {
      ...
      if (!this.isBusy) {
        try {
          this.setBusy(!0);
          let e = yield this.serviceProvider.getByQuery(this.query);
          if ((this.setBusy(!1), !(e == null ? void 0 : e.length))) {
            new oe.Notice(`No results found for "${this.query}"`);
            return;
          }
...
var Wt = q(require('obsidian')),
  nt = class extends Wt.SuggestModal {
    ...
    getSuggestions(e) {
      return this.suggestion.filter((t) => {
        var n, i, s;
        let o = e == null ? void 0 : e.toLowerCase();
        return (
          ((n = t.title) == null ? void 0 : n.toLowerCase().includes(o)) ||
          ((i = t.author) == null ? void 0 : i.toLowerCase().includes(o)) ||
          ((s = t.publisher) == null ? void 0 : s.toLowerCase().includes(o))
        );
      });
    }
...
var Xt = q(require('obsidian')),
  it = class {
    ...
    jumpToNextCursorLocation() {
      return g(this, null, function* () {
        let e = this.app.workspace.getActiveViewOfType(Xt.MarkdownView);
        if (!e) return;
        let o = (yield this.app.vault.cachedRead(e.file)).length + 1,
          n = e.editor;
        n.focus(), n.setCursor(o, 0);
      });
    }
  };
...
function X(r, e) {
  ...
  if (A(r) && e) {
    var i = r.offsetHeight,
      s = r.offsetWidth;
    s > 0 && (o = ee(t.width) / s || 1), i > 0 && (n = ee(t.height) / i || 1);
  }
  return {
    width: t.width / o,
    height: t.height / n,
...
function lo(r) {
  ...
  if (!(!i || !s)) {
    var h = ao(n.padding, t),
      ...
      y = fe(v, w, b),
      T = l;
    t.modifiersData[o] = ((e = {}), (e[T] = y), (e.centerOffset = y - w), e);
  }
}
function po(r) {
  var e = r.state,
...
function uo(r) {
  ...
  return { x: ee(e * n) / n || 0, y: ee(t * n) / n || 0 };
}
function nr(r) {
  var e,
    t = r.popper,
  ...
  if (m) {
    ...
    if (
      ...
      v = D;
      var R = h && w === b && b.visualViewport ? b.visualViewport.height : w[y];
      (f -= R - o.height), (f *= l ? 1 : -1);
    }
    if (n === O || ((n === C || n === D) && i === pe)) {
      P = k;
      var L = h && w === b && b.visualViewport ? b.visualViewport.width : w[T];
      (p -= L - o.width), (p *= l ? 1 : -1);
    }
  }
  var S = Object.assign({ position: a }, m && co),
    V = c === !0 ? uo({ x: p, y: f }) : { x: p, y: f };
  if (((p = V.x), (f = V.y), l)) {
    var $;
...
function ge(r) {
  return X(_(r)).left + de(r).scrollLeft;
}
function ct(r) {
  var e = B(r),
    t = _(r),
...
function ie(r, e) {
  ...
  e === void 0 && (e = []);
  var o = ze(r),
    n = o === ((t = r.ownerDocument) == null ? void 0 : t.body),
    i = B(o),
    s = n ? [i].concat(i.visualViewport || [], he(o) ? o : []) : o,
    a = e.concat(s);
...
function ar(r, e) {
  return e === Ge ? Ee(ct(r)) : J(e) ? vo(e) : Ee(ut(_(r)));
}
function wo(r) {
  var e = ie(te(r)),
  ...
  var o = e === 'clippingParents' ? wo(r) : [].concat(e),
    ...
    s = n.reduce(
      function (a, l) {
        ...
        return (
          (a.top = Y(m.top, a.top)),
          (a.right = ce(m.right, a.right)),
          (a.bottom = ce(m.bottom, a.bottom)),
          (a.left = Y(m.left, a.left)),
          a
        );
      },
      ar(r, i),
...
function K(r, e) {
  ...
  var t = e,
    ...
    y = c === be ? w : v,
    T = {
      top: P.top - y.top + f.top,
      bottom: y.bottom - P.bottom + f.bottom,
      left: P.left - y.left + f.left,
      right: y.right - P.right + f.right,
    },
...
function ft(r, e) {
  ...
  var t = e,
    ...
    h = c
      ? a
        ? lt
        : lt.filter(function (u) {
            return G(u) === c;
          })
      : ne,
    E = h.filter(function (u) {
  ...
  if (!e.modifiersData[o]._skip) {
    for (
      var n = t.mainAxis,
        ...
        j = x === d,
        P = l || (j || !u ? [Se(d)] : xo(d)),
        v = [d].concat(P).reduce(function (we, re) {
          return we.concat(
            I(re) === Xe
              ? ft(e, {
                  placement: re,
      ...
      if (
        (i && se.push(H[V] <= 0),
        a && se.push(H[U] <= 0, H[Le] <= 0),
        se.every(function (we) {
          return we;
        }))
      ) {
        (R = S), (T = !1);
        ...
        var _e = u ? 3 : 1,
          Qe = function (re) {
            var Be = v.find(function (Ve) {
              var ae = y.get(Ve);
              if (ae)
                return ae.slice(0, re).every(function (Je) {
                  return Je;
                });
            });
...
function cr(r) {
  return [C, k, D, O].some(function (e) {
    return r[e] >= 0;
  });
}
function yo(r) {
...
function Eo(r) {
  var e = r.state,
    ...
    n = t.offset,
    i = n === void 0 ? [0, 0] : n,
    s = Ue.reduce(function (c, h) {
      return (c[h] = So(h, e.rects, i)), c;
    }, {}),
    a = s[e.placement],
    l = a.x,
    m = a.y;
...
function Po(r) {
  var e = r.state,
    ...
    u = t.tetherOffset,
    f = u === void 0 ? 0 : u,
    d = K(e, { boundary: l, rootBoundary: m, padding: h, altBoundary: c }),
    x = I(e.placement),
    j = G(e.placement),
    P = !j,
    v = me(x),
  ...
  if (!!w) {
    if (i) {
      var $,
        ...
        Mr = U + Je - Ot - Ar,
        Ir = U + Dr - Ot,
        Bt = fe(p ? ce(Le, Mr) : Le, U, p ? Y(se, Ir) : se);
      (w[v] = Bt), (V[v] = Bt - U);
    }
    if (a) {
      var kt,
        ...
        Dt = le - d[Lr],
        et = [C, O].indexOf(x) !== -1,
        At = (kt = S == null ? void 0 : S[b]) != null ? kt : 0,
        Mt = et ? Nt : le - y[$e] - T[$e] - At + L.altAxis,
        It = et ? le + y[$e] + T[$e] - At - L.altAxis : Dt,
        Rt = p && et ? rr(Mt, le, It) : fe(p ? Mt : Nt, le, p ? It : Dt);
      (w[b] = Rt), (V[b] = Rt - le);
    }
    e.modifiersData[o] = V;
  }
...
function ht(r) {
  return r === B(r) || !A(r) ? de(r) : gt(r);
}
function Co(r) {
  var e = r.getBoundingClientRect(),
    t = ee(e.width) / r.offsetWidth || 1,
    o = ee(e.height) / r.offsetHeight || 1;
  return t !== 1 || o !== 1;
}
function vt(r, e, t) {
  t === void 0 && (t = !1);
...
function vr(r) {
  ...
  return function (a, l, m) {
    ...
    var c = {
      ...
      p = {
        ...
        setOptions: function (x) {
          ...
          if (
            ((c.orderedModifiers = P.filter(function (S) {
              return S.enabled;
            })),
            !1)
          ) {
            var v;
            if (getBasePlacement(c.options.placement) === auto) var b;
            var w, y, T, R, L;
          }
          return u(), p.update();
        },
        forceUpdate: function () {
          if (!E) {
            ...
            if (!!hr(j, P)) {
              ...
              for (var v = 0, b = 0; b < c.orderedModifiers.length; b++) {
                if (c.reset === !0) {
                  (c.reset = !1), (b = -1);
                  continue;
                }
    ...
    if (!hr(a, l)) return p;
    p.setOptions(m).then(function (d) {
      !E && m.onFirstUpdate && m.onFirstUpdate(d);
    });
    function u() {
...
var Oo = [sr, fr, ir, er, mr, lr, dr, or, ur],
  yt = vr({ defaultModifiers: Oo });
var Bo = (r, e) => ((r % e) + e) % e,
  xr = class {
    constructor(e, t, o) {
      (this.owner = e),
  ...
  St = class extends ve {
    ...
    getSuggestions(e) {
      let t = this.inputEl.selectionStart,
        ...
        i = [];
      return (
        this.processToken(n, (s, a) => {
          (this.lastInput = s[0]), i.push(a);
        }),
        i
      );
    }
  ...
  Ct = class extends W.PluginSettingTab {
    ...
    display() {
      ...
      let t = document.createDocumentFragment().createEl('code', {
        text: We(this.plugin.settings.fileNameFormat) || '{{title}} - {{author}}',
      });
      new W.Setting(e)
        ...
        (i = new W.Setting(e)
          ...
          .addDropdown((p) => {
            ...
            p.addOption(u, `${u} (Default Locale)`),
              window.moment.locales().forEach((d) => {
                p.addOption(d, d);
              });
          ...
          new W.Setting(e)
            ...
            .addDropdown((p) => {
              p.addOption(Q.snakeCase, Q.snakeCase.toString()),
                p.addOption(Q.camelCase, Q.camelCase.toString()),
...
function kr(r, e) {
  let t = /<%(?:=)(.+)%>/g,
    o = _o();
  return [...e.matchAll(t)].reduce((i, [s, a]) => {
    try {
      let l = new o(
        [
...
var Tt = class extends Pe.Plugin {
  ...
  showNotice(e) {
    try {
      new Pe.Notice(e == null ? void 0 : e.toString());
    } catch (t) {}
  }
  searchBookMetadata(e) {
    return g(this, null, function* () {
      let t = yield this.openBookSearchModal(e);
      return yield this.openBookSuggestModal(t);
    });
  }
  getRenderedContents(e) {
    return g(this, null, function* () {
      let {
        templateFile: t,
        useDefaultFrontmatter: o,
        defaultFrontmatterKeyType: n,
        frontmatter: i,
        content: s,
      } = this.settings;
      if (t) {
        let m = yield Or(this.app, t),
          c = Ne(e, Br(m));
        return kr(e, c);
      }
      let a = Ne(e, i);
...
${l}`
    ...
    return g(this, null, function* () {
      try {
        ...
        let o = yield this.getRenderedContents(e),
          n = Ut(e, this.settings.fileNameFormat),
  ...
  loadSettings() {
    return g(this, null, function* () {
      this.settings = Object.assign({}, jr, yield this.loadData());
    });
  }
  saveSettings() {
    return g(this, null, function* () {
